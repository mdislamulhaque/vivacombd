(function(window, document, $, undefined) {
    ...
    var nextgenInit = {
        ...
        methods: function(e) {
            nextgenInit.w();
            nextgenInit.contactForm();
            nextgenInit.nextgenBackToTop();
            nextgenInit.stickyHeaderMenu();
            nextgenInit.mobileMenuActivation();
            nextgenInit.salActivation();
            nextgenInit.nextgenMasonary();
            nextgenInit.counterUp();
            nextgenInit.nextgenSlickActivation();
            nextgenInit.magnificPopupActivation();
            nextgenInit.countdownInit('.countdown', '2022/12/01');
            nextgenInit.tiltAnimation();
            nextgenInit.menuLinkActive();
            nextgenInit.audioPlayerActivation();
            nextgenInit.onePageNav();
            nextgenInit.pricingPlan();
            nextgenInit.marqueImages();
            nextgenInit.nextgenHover();
            nextgenInit.onePageTopFixed();
            nextgenInit.blogModalActivation();
            nextgenInit.portfolioModalActivation();
            nextgenInit.caseModalActivation();
           
        },

        w: function(e) {
            this._window.on('load', nextgenInit.l).on('scroll', nextgenInit.res)
        },

        contactForm: function() {
            $('.nextgen-contact-form').on('submit', function(e) {
                e.preventDefault();
                var _self = $(this);
        ...
        stickyHeaderMenu: function() {
            ...
            $(window).on('scroll', function() {
                ...
                if ($('body').hasClass('sticky-header')) {
                    var stickyPlaceHolder = $('#nextgen-sticky-placeholder'),
                        menu = $('.nextgen-mainmenu'),
                        menuH = menu.outerHeight(),
                        topHeaderH = $('.nextgen-header-top').outerHeight() || 0,
                        targrtScroll = topHeaderH + 200;
                    if ($(window).scrollTop() > targrtScroll) {
                        menu.addClass('nextgen-sticky');
                        stickyPlaceHolder.height(menuH);
                    } else {
                        menu.removeClass('nextgen-sticky');
        ...
        mobileMenuActivation: function(e) {
            ...
            $('.menu-item-has-children > a').on('click', function(e) {
                ...
                var targetParent = $(this).parents('.mainmenu-nav'),
                    target = $(this).siblings('.nextgen-submenu'),
                    targetSiblings = $(this).parent('.menu-item-has-children').siblings().find('.nextgen-submenu');
            ...
            function resizeClassAdd() {
                if (window.matchMedia('(min-width: 992px)').matches) {
                    ...
                    $('.nextgen-mainmenu .offcanvas-backdrop').remove();
                    $('.nextgen-submenu').removeAttr('style');
                } else {
        ...
        nextgenMasonary: function () {
            $('.nextgen-isotope-wrapper').imagesLoaded(function () {
        ...
        nextgenSlickActivation: function(e) {
            $('.slick-slider').slick();
        },
        ...
        caseModalActivation : function () {
            ...
            if ($('body').hasClass('onepage-template')) {
                ...
                caseList.each(function() {
                    ...
                    var $this = $(this);
                    var buttons = $this.find('.nextgen-btn');
                    var title = $this.find('.title');
